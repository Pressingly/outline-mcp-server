...
def register_tools(mcp) -> None:
    ...
    if not read_only:
        ...
        async def create_collection(name: str, description: str = "", color: str | None = None) -> str:
            """
        ...
        async def update_collection(
            ...
            try:
                ...
                collection = await client.update_collection(collection_id, name, description, color)
