...
def _apply_edits(text: str, edits: list[DocumentEdit]) -> str:
    ...
    for edit in edits:
        ...
        if count > 1:
            snippet = old[:80]
            raise ValueError(f"'{snippet}' matches {count} locations. Include more surrounding context.")
    ...
    async def edit_document(
        ...
        try:
            ...
            if not edits and not (save and doc.dirty):
                ...
                return "No edits provided and no staged changes to save. Nothing to do."
