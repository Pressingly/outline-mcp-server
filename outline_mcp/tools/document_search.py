...
def _format_search_results(
    ...
    if pagination:
        ...
        if len(results) == limit:
            ...
            output += f"More results may be available. Use offset={next_offset} to see more.\n"
...
def register_tools(mcp) -> None:
    ...
    async def get_document_id_from_title(query: str, collection_id: str | None = None) -> str:
        """
